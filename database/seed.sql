...
INSERT INTO grades (id, enrollment_id, student_id, section_id, college_id, grade, marks, graded_by, graded_at) VALUES
    ('a1000000-0000-0000-0000-000000000001', 'f1000000-0000-0000-0000-000000000001', 'c1111111-1111-1111-1111-111111111111', 'e1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'A', 85.00, 'b2222222-2222-2222-2222-222222222222', NOW()),
    ('a1000000-0000-0000-0000-000000000002', 'f1000000-0000-0000-0000-000000000002', 'c2222222-2222-2222-2222-222222222222', 'e1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'B+', 78.00, 'b2222222-2222-2222-2222-222222222222', NOW()),
    ('a1000000-0000-0000-0000-000000000003', 'f1000000-0000-0000-0000-000000000003', 'c1111111-1111-1111-1111-111111111111', 'e1000000-0000-0000-0000-000000000004', 'a1111111-1111-1111-1111-111111111111', 'A-', 82.00, 'b3333333-3333-3333-3333-333333333333', NOW()),
    ('a1000000-0000-0000-0000-000000000004', 'f1000000-0000-0000-0000-000000000004', 'c2222222-2222-2222-2222-222222222222', 'e1000000-0000-0000-0000-000000000004', 'a1111111-1111-1111-1111-111111111111', 'B', 75.00, 'b3333333-3333-3333-3333-333333333333', NOW());

-- Fee Structures
INSERT INTO fee_structures (id, college_id, name, amount, semester, academic_year, due_date, is_active) VALUES
    ('b1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 'Semester 5 Tuition Fee', 45000.00, 5, 2024, '2024-08-15', TRUE),
    ('b1000000-0000-0000-0000-000000000002', 'a1111111-1111-1111-1111-111111111111', 'Semester 5 Lab Fee', 5000.00, 5, 2024, '2024-08-15', TRUE),
    ('b1000000-0000-0000-0000-000000000003', 'a1111111-1111-1111-1111-111111111111', 'Library Fee Annual', 2000.00, NULL, 2024, '2024-09-01', TRUE);

-- Sample Invoices
INSERT INTO invoices (id, student_id, fee_structure_id, college_id, total_amount, paid_amount, status, due_date) VALUES
    ('c1000000-0000-0000-0000-000000000001', 'c1111111-1111-1111-1111-111111111111', 'b1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 45000.00, 45000.00, 'PAID', '2024-08-15'),
    ('c1000000-0000-0000-0000-000000000002', 'c1111111-1111-1111-1111-111111111111', 'b1000000-0000-0000-0000-000000000002', 'a1111111-1111-1111-1111-111111111111', 5000.00, 0.00, 'PENDING', '2024-08-15'),
    ('c1000000-0000-0000-0000-000000000003', 'c2222222-2222-2222-2222-222222222222', 'b1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 45000.00, 20000.00, 'PARTIAL', '2024-08-15');

-- Sample Payments
INSERT INTO payments (id, invoice_id, college_id, amount, payment_method, transaction_id) VALUES
    ('d1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 'a1111111-1111-1111-1111-111111111111', 45000.00, 'ONLINE', 'TXN-2024-001'),
    ('d1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000003', 'a1111111-1111-1111-1111-111111111111', 20000.00, 'CASH', 'TXN-2024-002');
